...
training_args = SFTConfig(
    output_dir="outputs/qwen25omni-3b-instructMedic-notallpresent-trl-sft",  # Directory to save the model
    logging_dir='outputs/qwen25omni-3b-instructMedic-notallpresent-trl-sft/logs',
